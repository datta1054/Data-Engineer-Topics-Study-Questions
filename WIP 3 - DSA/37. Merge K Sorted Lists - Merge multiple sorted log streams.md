...
- [Inputs / Outputs / Constraints](#inputs--outputs--constraints-quick)
- [Motivating Examples](#motivating-examples)
- [Three-Level Approach Teaching](#three-level-approach-teaching-brute--better--optimal)
  - [Brute Force](#1-brute-force)
  - [Better — k-way Linear Scan](#2-better--k-way-linear-scan-using-pointers-naive-repeated-min-scan)
  - [Optimal — Min-Heap or Divide & Conquer](#3-optimal--min-heap-priority-queue-or-divide--conquer-preferred-heap)
- [Interview-Ready Solution (Optimal)](#interview-ready-solution-optimal)
- [Edge Cases, Pitfalls, and Trade-Offs](#edge-cases-pitfalls-and-trade-offs)
- [Follow-Ups & Hints](#follow-ups--hints-interview-style)
- [Practice Problems](#practice-problems)
- [How to Speak in the Interview](#how-to-speak-in-the-interview-mini-coaching)
- [Quick Checklist](#quick-checklist-what-to-say--do-in-interview)
- [Follow-up 1 — Infinite Streams (Real-Time Logs)](#follow-up-1--infinite-streams-real-time-logs)
- [Follow-up 2 — External Merge (Lists on Disk and N--memory)](#follow-up-2--external-merge-lists-on-disk-and-n--memory)
- [Combined Trade-Offs & Decision Guide](#combined-trade-offs--decision-guide)
- [Extra Interview Prep — Short Canned Answers](#extra-interview-prep--short-canned-answers-you-can-say-out-loud)
