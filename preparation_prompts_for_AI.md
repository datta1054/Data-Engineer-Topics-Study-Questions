...
Each study area → plug into one of these prompt templates. Each template is modular — start with Initial Prompt, then move through Follow-ups, Drill-downs, Interview Simulation, and Evaluation.
...
_Example:_
After doing a mock interview, ask: “Evaluate my readiness for Databricks Platform Administration interviews.”
