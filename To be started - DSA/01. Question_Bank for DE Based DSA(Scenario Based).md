# 🚀 Scenario-Based DSA Questions for Data Engineering Interviews
...
### 🟢 Easy
1. [Deduplicate a Small Daily Ingest (First Occurrence)](#1-deduplicate-a-small-daily-ingest-first-occurrence)
2. [Sliding Window Request Counter (Fixed Window)](#2-sliding-window-request-counter-fixed-window)
3. [Find Missing Integer in Small ID Range](#3-find-missing-integer-in-small-id-range)
4. [Merge Two Sorted Daily Snapshots (In-Place)](#4-merge-two-sorted-daily-snapshots-in-place)
5. [Count Distinct in a Small Window (Exact)](#5-count-distinct-in-a-small-window-exact)
6. [Reverse the Columns of a CSV Row](#6-reverse-the-columns-of-a-csv-row)
7. [Validate JSON-like Bracket Matching](#7-validate-json-like-bracket-matching)
8. [Partition Events by Day](#8-partition-events-by-day)
9. [Rotate Array by k (Cyclic Shift)](#9-rotate-array-by-k-cyclic-shift)
10. [Count Zeros in Binary Representation Across IDs](#10-count-zeros-in-binary-representation-across-ids)

### 🟡 Medium
11. [Merge Multiple Sorted Partition Files (K-way Merge)](#11-merge-multiple-sorted-partition-files-k-way-merge)
12. [Find Top-k Most Frequent Events in Streaming Logs (Approximate)](#12-find-top-k-most-frequent-events-in-streaming-logs-approximate)
13. [Reconstruct Time Series with Missing Days (Longest Gap)](#13-reconstruct-time-series-with-missing-days-longest-gap)
14. [Rebalance Partitions by Size (Approximate Greedy)](#14-rebalance-partitions-by-size-approximate-greedy)
15. [Find Median Across Multiple Sorted Shards (Online Queries)](#15-find-median-across-multiple-sorted-shards-online-queries)
16. [Detect Cycles in Job Dependency Graph and Produce Recovery Plan](#16-detect-cycles-in-job-dependency-graph-and-produce-recovery-plan)
17. [Rolling Aggregate with Late Arrivals (Out-of-Order)](#17-rolling-aggregate-with-late-arrivals-out-of-order)
18. [Partition a Dataset to Minimize Cross-Join Cost](#18-partition-a-dataset-to-minimize-cross-join-cost)
19. [Find Longest Substring of Unique Tokens After Tokenization](#19-find-longest-substring-of-unique-tokens-after-tokenization)
20. [Efficiently Compute Hourly Distinct Users for 24 Hours from 1B Events](#20-efficiently-compute-hourly-distinct-users-for-24-hours-from-1b-events)
21. [Merge Intervals with Attribute Propagation](#21-merge-intervals-with-attribute-propagation)
22. [Reorder Log Lines by Event_id with Allowed Out-of-Order Window](#22-reorder-log-lines-by-event_id-with-allowed-out-of-order-window)
23. [Transform Wide Table to Tall Schema (Unpivot) Efficiently](#23-transform-wide-table-to-tall-schema-unpivot-efficiently)
24. [Find Duplicate Files by Content Hash in a Directory Tree](#24-find-duplicate-files-by-content-hash-in-a-directory-tree)
25. [Range Query on Time-Partitioned Data (Fast Lookup)](#25-range-query-on-time-partitioned-data-fast-lookup)
26. [Detect Drift in Distribution Between Two Samples](#26-detect-drift-in-distribution-between-two-samples)
27. [Build Compact Index for Time Series for Fast Range Retrieval](#27-build-compact-index-for-time-series-for-fast-range-retrieval)
28. [Compute Join Cardinality Estimate from Sampled Statistics](#28-compute-join-cardinality-estimate-from-sampled-statistics)
29. [Streaming Dedupe with TTL Window](#29-streaming-dedupe-with-ttl-window)
30. [Generate a Minimal Transformation Pipeline to Compute Derived Metric](#30-generate-a-minimal-transformation-pipeline-to-compute-derived-metric)
31. [Find Connected Devices from Daily Heartbeat Graph](#31-find-connected-devices-from-daily-heartbeat-graph)
32. [Compact Sparse Vector Representation and Dot Product](#32-compact-sparse-vector-representation-and-dot-product)
33. [Find the Earliest Timestamp Where Cumulative Sum Crosses Threshold Across Partitions](#33-find-the-earliest-timestamp-where-cumulative-sum-crosses-threshold-across-partitions)
34. [Efficient Deduplication Across Time Using External Sort](#34-efficient-deduplication-across-time-using-external-sort)
35. [Fault-Tolerant Streaming Aggregator with Checkpointing](#35-fault-tolerant-streaming-aggregator-with-checkpointing)
36. [Detect Heavy Hitters with Sliding Window (Exact for Heavy Ones)](#36-detect-heavy-hitters-with-sliding-window-exact-for-heavy-ones)
37. [Schema Evolution Compatibility Checker](#37-schema-evolution-compatibility-checker)
38. [Compute Approximate Distinct Counts Per Key with Merging](#38-compute-approximate-distinct-counts-per-key-with-merging)
39. [Efficient Deduplication with Approximate Bloom + Exact Confirm (Two-Stage)](#39-efficient-deduplication-with-approximate-bloom--exact-confirm-two-stage)
40. [Optimize Broadcast Join vs Shuffle Join Decision](#40-optimize-broadcast-join-vs-shuffle-join-decision)

### 🔴 Hard
41. [Build a Distributed Median Estimator with Bounded Error and Merges](#41-build-a-distributed-median-estimator-with-bounded-error-and-merges)
42. [Design an Exactly-Once Distributed Join Pipeline with Failures](#42-design-an-exactly-once-distributed-join-pipeline-with-failures)
43. [Global Top-k Percentiles Across Time with Sliding Windows and Expiring Data](#43-global-top-k-percentiles-across-time-with-sliding-windows-and-expiring-data)
44. [Design a Scalable System to Find Near-Duplicate Documents at Petabyte Scale](#44-design-a-scalable-system-to-find-near-duplicate-documents-at-petabyte-scale)
45. [Build a Consistent Distributed Hash Table with Range Queries](#45-build-a-consistent-distributed-hash-table-with-range-queries)
46. [Real-Time Join Across Many Streams with Low Latency and Bounded Memory](#46-real-time-join-across-many-streams-with-low-latency-and-bounded-memory)
47. [Design a Multi-Tenant Metric Store with Fast Rollups & Retention Policies](#47-design-a-multi-tenant-metric-store-with-fast-rollups--retention-policies)
48. [Federated Search Ranking with Partial Signals from Shards](#48-federated-search-ranking-with-partial-signals-from-shards)
49. [Multi-Stage Pipeline Optimization: Choose Materialization Points](#49-multi-stage-pipeline-optimization-choose-materialization-points)
50. [Build a Scalable Lineage Tracker that Finds Root Causes](#50-build-a-scalable-lineage-tracker-that-finds-root-causes)
...
### 39. Efficient Deduplication with Approximate Bloom + Exact Confirm (Two-Stage)
- **Difficulty:** Medium
